    ...
    return (
        <View className="flex-1 bg-background px-8 pt-16">
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 50}}>
                ...
                <Text className="mt-6 text-white fron-extrabold text-3xl">
                    Criar Hábito
                </Text>

                <Text className="mt-6 text-white fron-semibold text-base">
                ...
                <TouchableOpacity className="w-full h-14 flex-row items-center justify-center bg-green-600 rounded-md mt-6" activeOpacity={0.6}>
